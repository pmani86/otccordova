 ...
 */
 	...
 	var libScr = document.createElement('script');
		libScr.type = 'text/javascript';
		libScr.src = 'libraryNA.js';
		
		libScr.onload = function() {
			testFun('Function called');
		};
		
		document.head.appendChild(libScr);
