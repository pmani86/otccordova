...
},{"cordova/exec":undefined,"debug":17,"random-number":22,"yaeti":23}],3:[function(require,module,exports){
/**
...
MediaStream.prototype.toggleCamera = function () {
	exec(null, null, 'iosrtcPlugin', 'MediaStream_toggleCamera', [this.id]);
};
...
},{"./MediaStreamTrack":6,"cordova/exec":undefined,"debug":17,"yaeti":23}],5:[function(require,module,exports){
/**
...
MediaStreamRenderer.prototype.render = function (stream) {
	...
	function connected() {
		...
		self.element.dispatchEvent(new Event('playing'));
	}
};
...
},{"./MediaStream":4,"cordova/exec":undefined,"debug":17,"random-number":22,"yaeti":23}],6:[function(require,module,exports){
/**
...
},{"./enumerateDevices":12,"cordova/exec":undefined,"debug":17,"yaeti":23}],7:[function(require,module,exports){
/**
...
},{"cordova/exec":undefined,"debug":17,"random-number":22,"yaeti":23}],8:[function(require,module,exports){
/**
...
},{"cordova/exec":undefined,"debug":17,"random-number":22,"yaeti":23}],9:[function(require,module,exports){
/**
...
},{"./Errors":1,"./MediaStream":4,"./RTCDTMFSender":7,"./RTCDataChannel":8,"./RTCIceCandidate":9,"./RTCSessionDescription":11,"cordova/exec":undefined,"debug":17,"random-number":22,"yaeti":23}],11:[function(require,module,exports){
/**
...
},{"./MediaDeviceInfo":3,"cordova/exec":undefined,"debug":17}],13:[function(require,module,exports){
/**
...
function getUserMedia(constraints) {
	...
	if (videoRequested) {
		...
		// Get requested video facingMode.
		if (typeof constraints.video.facingMode === 'string') {
			newConstraints.videoFacingMode = constraints.video.facingMode === 'environment';
		}
...
},{"./Errors":1,"./MediaStream":4,"cordova/exec":undefined,"debug":17}],14:[function(require,module,exports){
(function (global){
/**
 * Variables.
 */
...
domready(function () {
	...
	videoElementsHandler(mediaStreams, mediaStreamRenderers, imgRenderers);
});
...
function refreshVideos() {
	...
	for (id in imgRenderers) {
		if (imgRenderers.hasOwnProperty(id)) {
			imgRenderers[id].refresh();
		}
	}
}
...
},{"./MediaStream":4,"./MediaStreamTrack":6,"./RTCIceCandidate":9,"./RTCPeerConnection":10,"./RTCSessionDescription":11,"./enumerateDevices":12,"./getUserMedia":13,"./rtcninjaPlugin":15,"./videoElementsHandler":16,"cordova/exec":undefined,"debug":17,"domready":19}],15:[function(require,module,exports){
/**
...
},{"./MediaStreamTrack":6,"./RTCIceCandidate":9,"./RTCPeerConnection":10,"./RTCSessionDescription":11,"./enumerateDevices":12,"./getUserMedia":13}],16:[function(require,module,exports){
(function (global){
/**
...
},{"./ImgRenderer":2,"./MediaStreamRenderer":5,"debug":17}],17:[function(require,module,exports){
(function (process){
/**
...
},{"./debug":18,"_process":21}],18:[function(require,module,exports){
