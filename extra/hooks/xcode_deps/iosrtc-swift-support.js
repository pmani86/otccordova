...
module.exports = function (context) {
	...
	xcodeProject.parse(function (error) {
        ...
        var plistName = projectName + "-Info.plist";
        var filePath = path.join(projectRoot, 'platforms', 'ios', projectName, plistName);
	var xml = fs.readFileSync(filePath, 'utf8');
	var obj = plist.parse(xml);

	obj.NSCameraUsageDescription = 'We need your permission to use the camera.';
	obj.NSMicrophoneUsageDescription = 'We need your permission to use the microphone.';
	obj.NSCalendarsUsageDescription = 'We need your permission to view the calendar.';
	xml = plist.build(obj);
